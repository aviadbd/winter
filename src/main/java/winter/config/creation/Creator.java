...
import winter.config.model.Parameter;
...
/**
 * The Creator class is where {@link winter.config.model.Instance} classes become initialized user-domain classes. By invoking the
